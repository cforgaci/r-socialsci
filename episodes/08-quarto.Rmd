...
```{r rmarkdown-wizards, echo = FALSE, fig.show = "hold", fig.alt = "A schematic representing the multi-language input (e.g. Python, R, Observable, Julia) and multi-format output (e.g. PDF, HTML, Word documents, and more) versatility of Quarto.", out.width="100%"}
knitr::include_graphics("fig/quarto-illustration.png")
```
